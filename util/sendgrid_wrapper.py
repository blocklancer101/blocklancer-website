...
def notify_admins(message, subject=None):
    return notify_(message, subject, Email('info@blocklancer.vn', 'Sharing Economy Team'))

def notify_founders(message, subject=None):
    return notify_(message, subject, Email('founders@blocklancer.vn', 'Sharing Economy Founders'))
...
def notify_(message, subject=None, to_notify=None):
    ...
    send_message(
        sender=Email('bot@blocklancer.vn', 'Emily the bot'),
